      ...
      <div class="container-xxl py-5">
        <div class="container">
          ...
          <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <!-- MENU KISMI - DİZİ İLE DEĞİŞTİRECEĞİZ -->
                  ...
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span><?php echo $menu[0][$i][0]; ?></span>
                          <span class="text-primary"><?php echo $menu[0][$i][1]; ?> TL</span>
                        </h5>
                        <small class="fst-italic"
                          ><?php echo $menu[0][$i][2]; ?></small
                        >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        <h5
                          class="d-flex justify-content-between border-bottom pb-2"
                        >
                          <span><?php echo $menu[1][$i][0]; ?></span>
                          <span class="text-primary"><?php echo $menu[1][$i][1]; ?> TL</span>
                        </h5>
                        <small class="fst-italic"
                          ><?php echo $menu[1][$i][2]; ?></small
                        >
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        <h5
                          class="d-flex justify-content-between border-bottom pb-2"
                        >
                          <span><?php echo $menu[2][$i][0]; ?></span>
                          <span class="text-primary"><?php echo $menu[2][$i][1]; ?> TL</span>
                        </h5>
                        <small class="fst-italic"
                          ><?php echo $menu[2][$i][2]; ?></small
                        >
                      </div>
                    </div>
                  </div>  
