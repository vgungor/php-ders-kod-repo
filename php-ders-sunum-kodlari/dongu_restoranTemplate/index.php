...
<html lang="en">
  ...
  <body>
    <?php require 'anahtarli-menu.php'; ?>
          ...
          <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="tab-content">
                  ...
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span><?php echo $item['urun']; ?></span>
                          <span class="text-primary"><?php echo $item['fiyat']; ?> TL</span>
                        </h5>
                        <small class="fst-italic"
                          ><?php echo $item['icerik']; ?></small
                        >
                      </div>
                    </div>
                  </div>
              ...
              <div id="tab-2" class="tab-pane fade show p-0">
                <div class="row g-4">
                <?php
                    foreach ($menu["icecekler"] as $item){
                  ?>                
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      <img
              ...
              <div id="tab-3" class="tab-pane fade show p-0">
                <div class="row g-4">
                  <?php
                    foreach ($menu["anaYemekler"] as $item):
                  ?>  
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      <img
